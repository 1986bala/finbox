...
## Tags / keywords (for reference — used in description above, not a
separate Play Console field)
sip calculator, lumpsum calculator, fd calculator, rd calculator,
swp calculator, emi calculator, loan calculator, step up sip, mutual fund
calculator, investment calculator india

## Contact details (Play Console → Store settings)
- Play Console account: 1986balap@gmail.com
- Support email (shown publicly on the listing): help.techgig@gmail.com
- Privacy policy URL: (the one you already have hosted)
